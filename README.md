...
All JavaScript was tested extensively in a few ways. Firstly, as JS in primarily used to control UI interactions on the page it was tested manually by going through all possible interactions and testing that the JS manipulated or created the UI in the intented way.
